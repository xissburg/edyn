...
struct island_solver_context {
    ...
    island_solver_context(entt::registry &registry_, entt::entity island_entity_,
                          uint8_t num_iterations_, uint8_t num_position_iterations_,
                          scalar dt_, atomic_counter_sync *counter)
        : registry(&registry_)
        , island_entity(island_entity_)
        , num_iterations(num_iterations_)
        , num_position_iterations(num_position_iterations_)
        , dt(dt_)
