...
void narrowphase::update_async(job &completion_job) {
    ...
    parallel_for_async(dispatcher, size_t{0}, manifold_view.size(), size_t{1}, completion_job,
            [this, body_view, tr_view, com_view, manifold_view, cp_view, imp_view, tire_view, shapes_views_tuple] (size_t index) {
        ...
        process_collision(entity, manifold, result, cp_view, imp_view, tr_view, com_view, tire_view,
