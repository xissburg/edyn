#ifndef EDYN_NETWORKING_UTIL_ASSIGN_PREVIOUS_TRANSFORMS_HPP
#define EDYN_NETWORKING_UTIL_ASSIGN_PREVIOUS_TRANSFORMS_HPP
...
#endif // EDYN_NETWORKING_UTIL_ASSIGN_PREVIOUS_TRANSFORMS_HPP
