...
inline void update_present_position(entt::registry &registry, scalar dt) {
    auto view = registry.view<present_position, const position, const linvel>(exclude_global);
